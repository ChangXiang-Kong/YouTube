...
public partial class ConfirmDialogViewModel : DialogViewModel
{
    ...
    private readonly double _desktopMinWidth = 330;
    private readonly double _desktopMaxWidth = 1000;
    private readonly double _desktopMinHeight = 200;
    ...
    public InfoType InfoType
    {
        ...
        set
        {
            ...
            switch (field)
            {
                case InfoType.Ask:
                    IconText = "\xe3e8";
                    IconGeometry = _geometryAsk;
                    IconForeground = "DodgerBlue";
                    break;
                case InfoType.Info:
                    IconText = "\xe2ce";
                    IconGeometry = _geometryInfo;
                    IconForeground = "#2cb8c5";
                    break;
                case InfoType.Success:
                    IconText = "\xe184";
                    IconGeometry = _geometrySuccess;
                    IconForeground = "#3bb346";
                    break;
                case InfoType.Warning:
                    IconText = "\xe4e0";
                    IconGeometry = _geometryWarning;
                    IconForeground = "#fc8800";
                    break;
                case InfoType.Error:
                    IconText = "\xe4f8";
                    IconGeometry = _geometryError;
                    IconForeground = "#f93920";
                    break;
                case InfoType.Fatal:
                    IconText = "\xea96";
                    IconGeometry = _geometryFatal;
                    IconForeground = "#c738ff";
                    break;
            }
        }
    }
